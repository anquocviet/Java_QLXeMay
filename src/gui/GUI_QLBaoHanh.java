...
public class GUI_QLBaoHanh extends JPanel implements ActionListener, MouseListener, KeyListener {
	...
	public GUI_QLBaoHanh() {
		...
		JLabel lblTitlePBH = new JLabel("PHIẾU BẢO HÀNH");
		lblTitlePBH.setForeground(UIManager.getColor("InternalFrame.borderShadow"));
		lblTitlePBH.setFont(new Font("Lucida Grande", Font.BOLD, 20));
		GridBagConstraints gbc_lblTitlePBH = new GridBagConstraints();
		gbc_lblTitlePBH.gridwidth = 4;
		gbc_lblTitlePBH.insets = new Insets(0, 0, 5, 0);
		gbc_lblTitlePBH.fill = GridBagConstraints.VERTICAL;
		gbc_lblTitlePBH.gridx = 0;
		gbc_lblTitlePBH.gridy = 0;
		panelTitle.add(lblTitlePBH, gbc_lblTitlePBH);
		...
		gbc_lblTitleMaHD.insets = new Insets(0, 0, 5, 5);
		...
		JLabel lblTitleGio = new JLabel("Giờ (nhận/giao xe):");
		lblTitleGio.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		GridBagConstraints gbc_lblTitleGio = new GridBagConstraints();
		gbc_lblTitleGio.anchor = GridBagConstraints.EAST;
		gbc_lblTitleGio.insets = new Insets(0, 0, 5, 5);
		gbc_lblTitleGio.gridx = 2;
		gbc_lblTitleGio.gridy = 1;
		panelTitle.add(lblTitleGio, gbc_lblTitleGio);

		JLabel lblGio = new JLabel("9h/10h");
		GridBagConstraints gbc_lblGio = new GridBagConstraints();
		gbc_lblGio.insets = new Insets(0, 0, 5, 0);
		gbc_lblGio.anchor = GridBagConstraints.WEST;
		gbc_lblGio.gridx = 3;
		gbc_lblGio.gridy = 1;
		panelTitle.add(lblGio, gbc_lblGio);
		...
		gbc_lblTitleNgayLap.anchor = GridBagConstraints.WEST;
		gbc_lblTitleNgayLap.insets = new Insets(0, 0, 0, 5);
		gbc_lblTitleNgayLap.gridx = 0;
		gbc_lblTitleNgayLap.gridy = 2;
		...
		gbc_lblNgayLap.insets = new Insets(0, 0, 0, 5);
		gbc_lblNgayLap.gridx = 1;
		...
		lblTienLK.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		lblTienLK.setHorizontalAlignment(SwingConstants.RIGHT);
		GridBagConstraints gbc_lblTienLK = new GridBagConstraints();
		gbc_lblTienLK.fill = GridBagConstraints.BOTH;
		gbc_lblTienLK.insets = new Insets(0, 0, 5, 5);
		gbc_lblTienLK.gridx = 0;
		gbc_lblTienLK.gridy = 1;
		panelTinhTien.add(lblTienLK, gbc_lblTienLK);

		txtTienLK = new JTextField();
		GridBagConstraints gbc_txtTienLK = new GridBagConstraints();
		gbc_txtTienLK.fill = GridBagConstraints.BOTH;
		gbc_txtTienLK.insets = new Insets(0, 0, 5, 0);
		gbc_txtTienLK.gridx = 1;
		gbc_txtTienLK.gridy = 1;
		panelTinhTien.add(txtTienLK, gbc_txtTienLK);
		txtTienLK.setColumns(10);
		...
		JLabel lblTongTien = new JLabel("Tổng tiền phải trả");
		lblTongTien.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		...
		panelTinhTien.add(lblTongTien, gbc_lblTongTien);

		txtTongTien = new JTextField();
		GridBagConstraints gbc_txtTongTien = new GridBagConstraints();
		gbc_txtTongTien.insets = new Insets(0, 0, 5, 0);
		gbc_txtTongTien.fill = GridBagConstraints.BOTH;
		gbc_txtTongTien.gridx = 1;
		gbc_txtTongTien.gridy = 3;
		panelTinhTien.add(txtTongTien, gbc_txtTongTien);
		txtTongTien.setColumns(10);

		btnXuatHoaDon = new JButton("Xuất hóa đơn");
		btnXuatHoaDon.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		btnXuatHoaDon.setIcon(new ImageIcon(imagePrinter));
		GridBagConstraints gbc_btnXuatHoaDon = new GridBagConstraints();
		gbc_btnXuatHoaDon.gridx = 1;
		gbc_btnXuatHoaDon.gridy = 4;
		panelTinhTien.add(btnXuatHoaDon, gbc_btnXuatHoaDon);
